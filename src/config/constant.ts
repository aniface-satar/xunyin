...
export enum NAV_SHEAR_NATIVE_IDS {
  ...
  leaderboardDetail_content = 'leaderboardDetail_content',
  mylistDetail_content = 'mylistDetail_content',
}
...
export const NAV_MENUS = [
  { id: 'nav_discover', icon: 'leaderboard' },
  { id: 'nav_love', icon: 'love' },
  { id: 'nav_search', icon: 'search-2' },
] as const

export type NAV_ID_Type = typeof NAV_MENUS[number]['id'] | 'nav_setting'
...
export const DEFAULT_SETTING = {
  ...
  viewPrevState: {
    id: 'nav_discover' as NAV_ID_Type,
    // query: {},
  },
}
