...
import { isMusicCollected, setMusicCollected } from '@/core/player/love'
...
const updateRemoteLoveState = (ids: string[]) => {
  if (!global.lx.playerStatus.isInitialized || !ids.includes(LIST_IDS.LOVE)) return
...
const registerPlaybackService = async() => {
  ...
  global.app_event.on('myListMusicUpdate', updateRemoteLoveState)
