...
export default {
  ...
  getAlbumInfo(id, retryNum = 0) {
    ...
    const requestObj = httpFetch(`http://search.kuwo.cn/r.s?pn=0&rn=1&stype=albuminfo&albumid=${id}&show_copyright_off=0&encoding=utf&vipver=MUSIC_9.1.0`)
